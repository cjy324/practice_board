...
(function () {
        ...
        this.startIframRequest = function(forDownloadFilelist, forDownloadFilelistIndex) {
            ...
            const startInterval = setInterval(function(){
                if(progressPercentage < 100){  // 다운로드 진행률 값이 100보다 작으면..
                    this.checkDownProgress(downFileGuid, forDownloadFilelist, forDownloadFilelistIndex);
                    ...
                    if(forDownloadFilelistIndex < forDownloadFilelist.length-1){ // 아직 다운로드해야 할 파일이 남았는지 체크
                        ...
                        this.startIframRequest(forDownloadFilelist, forDownloadFilelistIndex); // 다음 파일 다운로드 시작
                    }
                }
            }, 100);  // ex) 1초 = 1000
    ...
    document.body.onload = EXAMDownloader.fileLoad;
